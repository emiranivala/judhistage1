...
async def generate_session(_, message):
    ...
    try:
        ...
        try:
            two_step_msg = await _.ask(user_id, 'Your account has two-step verification enabled. Please enter your password with in 5 Minutes.', filters=filters.text, timeout=300)
        except TimeoutError:
